package com.wsruralhouse.gui.components.table.cell.component;
...
import com.wsruralhouse.gui.components.table.CellComponent;
import com.wsruralhouse.gui.components.table.CellComponentInterface;
import com.wsruralhouse.gui.user.MainWindow;
import com.wsruralhouse.gui.user.client.BookingsTablePanel;
...
public class BookingsComponent extends AbstractCellEditor implements CellComponentInterface {
	...
	public JButton getBtnCancelBooking() {
		if(btnCancelBooking == null) {
			...
			btnCancelBooking.setIcon(new ImageIcon(BookingsComponent.class.getResource("/main/resources/img/icons/cancel_button/cancel-offer_default.png")));
			btnCancelBooking.setSelectedIcon(new ImageIcon(BookingsComponent.class.getResource("/main/resources/img/icons/cancel_button/cancel-offer_default.png")));
			btnCancelBooking.setRolloverIcon(new ImageIcon(BookingsComponent.class.getResource("/main/resources/img/icons/cancel_button/cancel-offer_hover.png")));
			btnCancelBooking.setRolloverSelectedIcon(new ImageIcon(BookingsComponent.class.getResource("/main/resources/img/icons/cancel_button/cancel-offer_pressed.png")));
			btnCancelBooking.setPressedIcon(new ImageIcon(BookingsComponent.class.getResource("/main/resources/img/icons/cancel_button/cancel-offer_pressed.png")));
