...
public class ConsoleKeyEventDispatcher implements KeyEventDispatcher {
	...
	private void showMessage() {
		...
		String message = null;
		String audioFile = "/main/resources/img/major_puzzle_solved.wav";
		millis = -1;
		boolean fade = true;
		...
		case 6:
			...
			audioFile = "/main/resources/img/major_puzzle_solved_reversed.wav";
			millis = 10000;
			fade = false;
			break;
		}
		...
		if(count == 6) {
			Thread thread = new Thread(new Runnable() {			
				...
				public void run() {
					try {
						new GlitchImagePanel(Arrays.asList("/main/resources/img/glitch.gif", "/main/resources/img/glitched.gif"), millis);
						Thread.sleep(millis);	
						System.exit(666);
