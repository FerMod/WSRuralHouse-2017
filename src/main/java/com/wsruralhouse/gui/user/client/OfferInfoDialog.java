package com.wsruralhouse.gui.user.client;
...
import com.wsruralhouse.gui.components.FrameShader;
import com.wsruralhouse.gui.components.ImagePanel;
import com.wsruralhouse.gui.components.InfoTextPane;
...
public class OfferInfoDialog extends JDialog {
	...
	private JButton getDialogTitleCloseButton() {
		if(btnX == null) {
			...
			btnX.setIcon(new ImageIcon(OfferInfoDialog.class.getResource("/main/resources/img/icons/close_button/window-close.png")));
			btnX.setSelectedIcon(new ImageIcon(OfferInfoDialog.class.getResource("/main/resources/img/icons/close_button/window-close.png")));
			btnX.setRolloverSelectedIcon(new ImageIcon(OfferInfoDialog.class.getResource("/main/resources/img/icons/close_button/window-close_pressed.png")));
			btnX.setRolloverIcon(new ImageIcon(OfferInfoDialog.class.getResource("/main/resources/img/icons/close_button/window-close_hover.png")));
			btnX.setPressedIcon(new ImageIcon(OfferInfoDialog.class.getResource("/main/resources/img/icons/close_button/window-close_pressed.png")));
