...
import com.wsruralhouse.domain.Admin;
...
public class OwnerRuralHousesPanel extends JPanel {
	...
	public OwnerRuralHousesPanel(JFrame frame) { //Need a JScrollPane		
		...
		btnNewButton_2.setIcon(new ImageIcon(OwnerRuralHousesPanel.class.getResource("/main/resources/img/updaterhs0.gif")));
		btnNewButton_2.setBounds(295, 44, 52, 52);
		add(btnNewButton_2);

		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(OwnerRuralHousesPanel.class.getResource("/main/resources/img/editrh.gif")));
		...
		button.setIcon(new ImageIcon(OwnerRuralHousesPanel.class.getResource("/main/resources/img/newrhs0.gif")));
