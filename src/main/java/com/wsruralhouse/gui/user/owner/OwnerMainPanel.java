package com.wsruralhouse.gui.user.owner;
...
//					int row = table.rowAtPoint(p);
	...
	private class TableModel extends AbstractTableModel {
		...
		private Object[][] data = {
				{new ImageIcon("/main/resources/img/house00.png"), "Kathy", "Smith", "Snowboarding", new Integer(5), new Boolean(false) },
				{new ImageIcon("/main/resources/img/house00.png"), "John", "Doe", "Rowing", new Integer(3), new Boolean(true) },
				{new ImageIcon("/main/resources/img/house00.png"), "Sue", "Black", "Knitting", new Integer(2), new Boolean(false) },
				{new ImageIcon("/main/resources/img/house00.png"), "Jane", "White", "Speed reading", new Integer(20), new Boolean(true) },
				{new ImageIcon("/main/resources/img/house00.png"), "Joe", "Brown", "Pool", new Integer(10), new Boolean(false) }
		};

		private String[] images = {"/main/resources/img/house00.png", "/main/resources/img/house01.png", "/main/resources/img/house02.png", "/main/resources/img/house03.png", "/main/resources/img/house04.png"};
