...
public class OfferInfoDialog extends JDialog {
	...
	private static Point getFrameCenter(Window frame) {
	  ...
	  g2.fillOval(frame.getLocation().x, frame.getLocation().y, 5, 5);
	...
	public OfferInfoDialog(JFrame parentFrame) {
		...
		tabbedPane.addTab("New tab", null, tabPanel1, null);


		JPanel tabPanel2 = new JPanel();
		tabbedPane.addTab("New tab", null, tabPanel2, null);



		JPanel bottomPanel = new JPanel();
		bottomPanel.setForeground(UIManager.getColor("Button.foreground"));
