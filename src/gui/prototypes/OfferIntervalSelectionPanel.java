...
public class OfferIntervalSelectionPanel extends JPanel {

	/**
	 * Generated serial version ID
	 */
	private static final long serialVersionUID = -8045645133278250112L;
	...
	public OfferIntervalSelectionPanel() {
	...
	private void jbInit() throws Exception {
		...
		Vector<RuralHouse> rhs = new Vector<>();//MainWindow.getBusinessLogic().getRuralHouses();

		comboBox = new JComboBox<RuralHouse>(rhs);
		//comboBox.setModel(new DefaultComboBoxModel(rhs));

		setSize(new Dimension(815, 641));
